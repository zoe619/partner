class RestaurantPendingOrdersModel {
  List<Data> data;
  Links links;
  Meta meta;
  String message;
  ...
  RestaurantPendingOrdersModel({this.data, this.links, this.meta, this.message, this.orderCount});

  RestaurantPendingOrdersModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
