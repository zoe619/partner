import 'package:order_tracker/models/restaurant_info_model.dart';

class RestaurantDetailsModel {
  Data data;
  String message;

  RestaurantDetailsModel({this.data, this.message});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    freeKm = json['free_km'].toString();
    isCouponEnabled = json['is_coupon_enabled'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_coupon_enabled'] = this.isCouponEnabled;
...
class Video {
  ...
  Video.fromJson(Map<String, dynamic> json) {
    ...
    //     topCategories.add(new String.fromJson(v));
    //   });
    // }
