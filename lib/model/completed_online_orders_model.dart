class CompletedOnlineOrdersModel {
  List<Data> data;
  Links links;
  Meta meta;
  String message;

  CompletedOnlineOrdersModel({this.data, this.links, this.meta, this.message});

  CompletedOnlineOrdersModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class OrderDetail {
  ...
  OrderDetail(
      {this.deliveryMethod, this.address, this.lat, this.lng, this.comment, this.phoneNumber});
