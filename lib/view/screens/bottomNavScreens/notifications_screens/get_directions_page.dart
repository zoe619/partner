...
class _MapViewState extends State<MapView> {
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        geo.Position startCoordinates = _startAddress == _currentAddress
            ? geo.Position(
        ...
        geo.Position destinationCoordinates = geo.Position(
        ...
        geo.Position _northeastCoordinates;
        geo.Position _southwestCoordinates;
        ...
        _southwestCoordinates = geo.Position(latitude: miny, longitude: minx);
        _northeastCoordinates = geo.Position(latitude: maxy, longitude: maxx);
  ...
  _createPolylines(geo.Position start, geo.Position destination) async {
    polylinePoints = PolylinePoints();
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      "AIzaSyB9GcDuo9eT2DypmthmRedRuCCflPhUEZg", // Google Maps API Key
